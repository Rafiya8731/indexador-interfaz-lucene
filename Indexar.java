...
import org.apache.lucene.analysis.standard.StandardAnalyzer;
    ...
    public class Indexar {
        ...
        public static void main(String[] args) {
            ...
            final String METADATA_DIR = "./metadata";
            final String REVIEWS_DIR = "./reviews";
            ...
            while (true) {
                ...
                while (opcion < 1 || opcion > 5) {
                    System.out.println("\nPor favor, selecciona una de las opciones a continuación:");
                    System.out.println("1. Metadata");
                    System.out.println("2. Metadata Analizado");
                    System.out.println("3. Reviews");
                    System.out.println("4. Reviews Agrupadas");
                    ...
                    switch (opcion) {
                        case 1:
                            tipoDato = "metadata";
                            directorio = METADATA_DIR;
                            break;
                        case 2:
                            tipoDato = "metadataEspecial";
                            directorio = METADATA_DIR;
                            break;
                        case 3:
                            tipoDato = "reviews";
                            directorio = REVIEWS_DIR;
                            break;
                        case 4:
                            tipoDato = "reviewsEspecial";
                            directorio = REVIEWS_DIR;
                            break;
                        case 5:
                ...
                while (opcion2 < 1 || opcion2 > 2) {
                    System.out.println("\nSelecciona un modo:");
                    System.out.println("1. Crear un nuevo índice");
                    System.out.println("2. Añadir al índice existente");
                    System.out.print("Tu selección: ");
                ...
                System.out.println("\nVas a hacer un <" + modo + "> en el índice <" + tipoDato + "> desde el directorio <" + directorio + "> .");
